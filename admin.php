        ...
        <tr>
          <td><form name="form1" method="get" action="admin.php">
              <p align="center">Search 
                ...
                <br>
                [Type University Registration No or User name] </p>
              <p align="center"> 
	  ...
	  // outputting the pages
        ...
        <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
          <tr bgcolor="#E6F3F9"> 
            ...
            <td width="24%"><strong>Register No</strong></td>
          ...
          <tr> 
			...
			University Register No:<input id="user_email<?php echo $rrows['id']; ?>" name="user_email<?php echo $rrows['id']; ?>" type="text" size="20" value="<?php echo $rrows['user_email']; ?>" >
