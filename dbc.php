...
define ("DB_NAME","studentdetails"); // set database name

$link = mysql_connect(DB_HOST, DB_USER, DB_PASS) or die("Couldn't make connection.");
$db = mysql_select_db(DB_NAME, $link) or die("Couldn't select database");
$dbLink = mysqli_connect("localhost", "root", "", "studentdetails"); 
...
/*************** reCAPTCHA KEYS****************/
$publickey = "6LdJ9cYSAAAAAOSiYwkc4GCEHZ-IL47C666ucioO";
$privatekey = "6LdJ9cYSAAAAALBZXkoSkk-KUkxmANsdDS8VHf_6";
