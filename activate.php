...
<h3 class="titlehdr">Account Activation</h3>
	...
	if(!empty($err))  {
      ...
      <p>Please enter your register no and activation code sent to you to your class advisor.To activate your account Contact your Advisor. Once your account is activated you can 
      ...
      <form action="activate.php" method="post" name="actForm" id="actForm" >
        <table width="65%" border="0" cellpadding="4" cellspacing="4" class="loginform">
          ...
          <tr> 
            <td width="36%">Your Register No</td>
            <td width="64%"><input name="user_email" type="text" class="" id="txtboxn" size="25"></td>
          </tr>
          <tr> 
